...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="checkbox" id="showPasswordCheckbox" style="height:15px; width:15px;" onclick="togglePassword()">
        <label for="showPasswordCheckbox" class="checkbox-label" style="margin-top:2px;" id="checkboxLabel">Show Password</label>
